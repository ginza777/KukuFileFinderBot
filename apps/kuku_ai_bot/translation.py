...
subscribe_channel_text = {
    "en": "Please click 👉 'Check Subscription' after subscribing to a channel.",
    "uz": "Iltimos, kanalga obuna bo'lganingizdan so'ng 👉 'Obunani tekshirish' tugmasini bosing.",
...
unlock_secret_room = {
    "uz": "Tabriklaymiz! Siz sirli xonani ochdingiz👁‍🗨. Siz uchun ba'zi ma'lumotlar mavjud:\n"
          "<b>Foydalanuvchilar</b>: {user_count}\n"
          "<b>24 soat faol</b>: {active_24}",
    "ru": "Поздравляем! Вы открыли секретную комнату👁‍🗨. Для вас есть некоторая информация:\n"
          "<b>Пользователи</b>: {user_count}\n"
          "<b>24 часа активно</b>: {active_24}",
    "en": "Congratulations! You've opened a secret room👁‍🗨. There is some information for you:\n"
          "<b>Users</b>: {user_count}\n"
          "<b>24h active</b>: {active_24}",

    "tr": "Tebrikler! Gizli bir oda açtınız👁‍🗨. Sizin için bazı bilgiler var:\n"
          "<b>Kullanıcılar</b>: {user_count}\n"
          "<b>24 saat aktif</b>: {active_24}"
...
help_message = {
    ...
    "ru": "\n🆘Помощь!\nЕсли у вас есть вопросы или предложения о создании бота, вы можете обратиться к создателю, нажав на кнопку ниже",
    "en": "\n🆘Help!\nIf you have some questions or suggestions about bot creation you can contact the creator via tap the button below ",
...
about_message = {
    "uz": "\n⛳Bot haqida!\nAgar sizda bot yaratish haqida savollar yoki takliflar bo'lsa, quyidagi tugmani bosib bot yaratuvchisiga murojaat qila olasiz",
    "ru": "\n⛳О боте!\nЕсли у вас есть вопросы или предложения о создании бота, вы можете обратиться к создателю, нажав на кнопку ниже",
    "en": "\n⛳About the bot!\nif you have some questions or questions about bot creation you can contact the creator via tap the button below",
    "tr": "\n⛳Bot hakkında!\nEğer bot oluşturma hakkında sorularınız veya önerileriniz varsa, aşağıdaki düğmeye basarak bot yaratıcısına başvurabilirsiniz"
}
...
input_valid_movie = {
    ...
    "tr": "Geçersiz giriş. Lütfen geçerli bir film kodu girin."
}
...
choice_language = {
    "en": "You choice language is - 🇺🇸  ",
    "uz": "Siz tilni tanlagan til - 🇺🇿 ",
    "ru": "Вы выбрали язык - 🇷🇺 ",
    "tr": "Seçtiğiniz dil - 🇹🇷"
}

restart_text = {
    "uz": "Botni qayta ishga tushirish uchun 🔁✅ boshlash ni bosing",
    "en": "Press  🔁✅restart to restart the bot",
    "ru": "Нажмите 🔁✅перезапуск, чтобы перезапустить бота",
    "tr": "Botu yeniden başlatmak için 🔁✅ başlatın"
}
